...
function ur() {
  if (Re)
    return k;
  Re = 1;
  var p = Oe, b = Symbol.for("react.element"), V = Symbol.for("react.fragment"), T = Object.prototype.hasOwnProperty, F = p.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, A = { key: !0, ref: !0, __self: !0, __source: !0 };
  function w(m, l, O) {
    var v, E = {}, _ = null, I = null;
    O !== void 0 && (_ = "" + O), l.key !== void 0 && (_ = "" + l.key), l.ref !== void 0 && (I = l.ref);
    for (v in l)
      T.call(l, v) && !A.hasOwnProperty(v) && (E[v] = l[v]);
    if (m && m.defaultProps)
      for (v in l = m.defaultProps, l)
        E[v] === void 0 && (E[v] = l[v]);
    return { $$typeof: b, type: m, key: _, ref: I, props: E, _owner: F.current };
  }
...
function sr() {
  return Te || (Te = 1, process.env.NODE_ENV !== "production" && function() {
    var p = Oe, b = Symbol.for("react.element"), V = Symbol.for("react.portal"), T = Symbol.for("react.fragment"), F = Symbol.for("react.strict_mode"), A = Symbol.for("react.profiler"), w = Symbol.for("react.provider"), m = Symbol.for("react.context"), l = Symbol.for("react.forward_ref"), O = Symbol.for("react.suspense"), v = Symbol.for("react.suspense_list"), E = Symbol.for("react.memo"), _ = Symbol.for("react.lazy"), I = Symbol.for("react.offscreen"), X = Symbol.iterator, Ce = "@@iterator";
    function Pe(e) {
    ...
    function Fe(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === T || e === A || De || e === F || e === O || e === v || ke || e === I || we || xe || je || typeof e == "object" && e !== null && (e.$$typeof === _ || e.$$typeof === E || e.$$typeof === w || e.$$typeof === m || e.$$typeof === l || // This needs to include all possible module reference object
    ...
    function Xe(e, r, t, n, i) {
      {
        ...
        t !== void 0 && (de(t), a = "" + t), qe(r) && (de(r.key), a = "" + r.key), Je(r) && (d = r.ref, Ge(r, i));
        for (u in r)
    ...
    function me(e, r, t, n, i, u) {
      {
        ...
        if (!o) {
          ...
          d ? a += d : a += be();
          var s;
          e === null ? s = "null" : J(e) ? s = "array" : e !== void 0 && e.$$typeof === b ? (s = "<" + (h(e.type) || "Unknown") + " />", a = " Did you accidentally export a JSX literal instead of a component?") : s = typeof e, c("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s, a);
        }
        var f = Xe(e, r, t, i, u);
        if (f == null)
          return f;
...
var fr = H.exports;
const lr = ir(void 0), dr = ({ children: p, appConfig: b }) => /* @__PURE__ */ fr.jsx(lr.Provider, { value: b, children: p }), vr = (p, b) => {
  if (typeof p > "u")
    return b;
  if (typeof p == "boolean")
    return p;
