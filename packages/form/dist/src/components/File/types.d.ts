...
export interface IFileUploadProperties extends Omit<IFileDropzoneBasicProperties, "onChange"> {
...
export type IFileDropzoneProperties = Omit<IFileDropzoneBasicProperties, "value" | "onChange">;
...
export type IFormFileInputProperties = Omit<IFileInputBasicProperties, "value" | "onChange">;
export interface IFileAttachBasicProperties extends Omit<IFileInputBasicProperties, "inputMethod" | "label" | "dropzoneMessage" | "selectedFileDisplay" | "inputButtonLabel" | "inputButtonLabelSelected"> {
